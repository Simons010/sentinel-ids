    ...
    <div className="bg-[#1E293B] border border-[#334155] rounded-lg p-6">
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <label
            htmlFor="file-upload"
            className="px-6 py-2.5 bg-[#22D3EE] text-white font-medium rounded-lg hover:bg-[#0EA5E9] transition-colors cursor-pointer peer-focus-visible:ring-2 peer-focus-visible:ring-white peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-[#1E293B]"
          >
            Browse Files
          </label>

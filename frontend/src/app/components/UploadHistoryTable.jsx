                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {item.status !== "processing" && (
                        <button
                          ...
                          disabled={actionsDisabled}
                          className="p-2 hover:bg-[#10B981]/10 rounded transition-colors group focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE]"
                          title="Reanalyze"
                      ...
                      <button
                        ...
                        disabled={actionsDisabled}
                        className="p-2 hover:bg-[#EF4444]/10 rounded transition-colors group focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE]"
                        title="Delete"

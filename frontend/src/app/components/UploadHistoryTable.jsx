                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="p-2 hover:bg-[#22D3EE]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22D3EE] rounded transition-colors group"
                        title="View logs"
                      >
                      ...
                      {item.status !== "processing" && (
                        <button
                          ...
                          className="p-2 hover:bg-[#10B981]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#10B981] rounded transition-colors group"
                          title="Reanalyze"
                        >
                      ...
                      <button
                        ...
                        className="p-2 hover:bg-[#EF4444]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EF4444] rounded transition-colors group"
                        title="Delete"
                      >

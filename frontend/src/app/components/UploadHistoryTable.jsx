                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="p-2 hover:bg-[#22D3EE]/10 rounded transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22D3EE] disabled:opacity-50 disabled:cursor-not-allowed"
                        title="View logs"
                      ...
                      {item.status !== "processing" && (
                        <button
                          ...
                          disabled={actionsDisabled}
                          className="p-2 hover:bg-[#10B981]/10 rounded transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22D3EE] disabled:opacity-50 disabled:cursor-not-allowed"
                          title="Reanalyze"
                      ...
                      <button
                        ...
                        disabled={actionsDisabled}
                        className="p-2 hover:bg-[#EF4444]/10 rounded transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22D3EE] disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Delete"

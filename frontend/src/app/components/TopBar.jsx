        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#0F172A] border border-[#334155] rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#22D3EE] transition-colors"
            />
          </div>
        </div>
      </div>

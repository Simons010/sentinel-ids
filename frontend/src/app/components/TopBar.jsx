        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#0F172A] border border-[#334155] rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#22D3EE] transition-colors focus-visible:ring-2 focus-visible:ring-[#22D3EE]"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <button className="relative p-2 hover:bg-[#0F172A] rounded-lg transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE]">
          ...
          <span className="absolute top-1 right-1 w-4 h-4 bg-[#EF4444] text-white text-xs rounded-full flex items-center justify-center">
            7<span className="sr-only"> unread alerts</span>
          </span>
        </button>

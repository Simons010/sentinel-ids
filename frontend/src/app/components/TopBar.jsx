  ...
  return (
    <div className="h-16 bg-[#1E293B] border-b border-[#334155] px-6 flex items-center justify-between">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#0F172A] border border-[#334155] rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#22D3EE] focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE] transition-colors"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 ml-6">
        {/* Live Status */}
        <div className="flex items-center gap-2 px-3 py-1.5 bg-[#0F172A] rounded-lg border border-[#334155]" role="status" aria-label="System is Live" title="System is Live">
          <div className="w-2 h-2 bg-[#10B981] rounded-full animate-pulse" aria-hidden="true"></div>
          <span className="text-sm font-medium text-[#10B981]">LIVE</span>
        </div>

        {/* Notification Bell */}
        <button
          className="relative p-2 hover:bg-[#0F172A] rounded-lg transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE]"
        ...
        {/* User Profile */}
        <button
          className="flex items-center gap-3 pl-3 pr-4 py-2 hover:bg-[#0F172A] rounded-lg transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE]"
          aria-label="User profile menu for Admin User, Security Analyst"
          aria-haspopup="menu"
        >

  ...
  return (
    <div className="h-16 bg-[#1E293B] border-b border-[#334155] px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4 ml-6">
        {/* Live Status */}
        <div className="flex items-center gap-2 px-3 py-1.5 bg-[#0F172A] rounded-lg border border-[#334155]" aria-label="System status: Live">
        ...
        {/* User Profile */}
        <button
          aria-label="User profile menu: Admin User"

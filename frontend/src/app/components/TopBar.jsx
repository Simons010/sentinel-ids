      ...
      <div className="flex items-center gap-4 flex-1 max-w-2xl">
        ...
        <div className="flex-1">
          <div className="relative">
            <label htmlFor="topbar-search" className="sr-only">Search logs, alerts, IPs</label>
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" aria-hidden="true" />
            <input
              id="topbar-search"
              type="text"
              placeholder="Search logs, alerts, IPs..."
              className="w-full bg-[#0F172A] border border-[#334155] rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#22D3EE] focus:border-[#22D3EE] transition-colors"
            />
          </div>
        </div>
      </div>

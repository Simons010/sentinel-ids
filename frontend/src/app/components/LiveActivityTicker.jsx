...
export function LiveActivityTicker({ events = [], onEventClick }) {
  const [isPaused, setIsPaused] = useState(false);
  const controls = useAnimationControls();

  // Memorize activities to prevent unnecessary re-renders
  ...
  }, [isPaused, activities, animationDuration, controls]);

            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white rounded focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#22D3EE]"
                >
                  {showPassword ? (

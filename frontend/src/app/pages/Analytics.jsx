  ...
  const modelMetrics = [
    {
      ...
      value: '98.2%',
      change: 2.1,
      sparklineData: [95, 95.5, 96, 96.8, 97.2, 97.6, 97.9, 98, 98.1, 98.2],
      accentColor: '#10B981'
    },
    {
      icon: TrendingUp,
      ...
      value: '96.7%',
      change: 1.8,
      sparklineData: [94, 94.5, 95, 95.5, 96, 96.2, 96.4, 96.5, 96.6, 96.7],
      accentColor: '#22D3EE'
    },
    {
      icon: Activity,
      ...
      value: '97.4%',
      change: 2.3,
      sparklineData: [93, 94, 95, 95.5, 96, 96.5, 97, 97.2, 97.3, 97.4],
      accentColor: '#F59E0B'
    },
    {
      icon: Award,
      ...
      value: '97.0%',
      change: 2.0,
      sparklineData: [93.5, 94, 94.8, 95.3, 95.8, 96.2, 96.5, 96.7, 96.9, 97.0],
      accentColor: '#EF4444'
    }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400">Machine learning insights and detection statistics</p>
      </div>

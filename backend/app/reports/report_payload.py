...
def build_report_snapshot(
    ...
    *,
    ...
    # Bolt Optimization: Consolidate 4 sequential .count() calls into a single .aggregate() call.
    # Expected impact: Reduces database table scans from 4 to 1 per request, improving response time.

...
def build_report_snapshot(
    ...
    *,
    ...
    # Consolidated 4 sequential .count() queries into a single .aggregate() call
    # Expected Impact: Reduces database queries from 4 to 1 per request for these metrics.

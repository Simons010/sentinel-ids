...
class NetworkStatsView(APIView):
    def get(self, request):
        ...
        # ⚡ Bolt Optimization: Replace 168 queries (7 days * 24 hrs) with a single query
        # and O(1) dictionary lookups in memory to drastically improve performance.
        hourly_counts = (
            alerts

...
class AnalyticsView(APIView):
    def get(self, request):
        ...
        # ⚡ Bolt: Consolidate 4 separate .count() queries into a single .aggregate() call
        # This reduces 4 database table scans down to 1, significantly improving performance.

    ...
    def get(self, request):
        ...
        for i in range(24):
            hourly_data.append({
                ...
                "normal": log_res.get(f'n_{i}', 0),
                "suspicious": log_res.get(f's_{i}', 0),
                "confirmed": alert_res.get(f'c_{i}', 0)
            })
...
class AnalyticsView(APIView):
    def get(self, request):
        ...
        log_res = logs_24h_base.aggregate(**log_aggs)
        alert_res = alerts_24h_base.aggregate(**alert_aggs)

...
class DashboardStatsView(APIView): 
    ...
    def get(self, request):
        ...
        log_results = logs_24h.aggregate(**log_aggs) if logs_24h.exists() else {}
        alert_results = alerts_24h.aggregate(**alert_aggs) if alerts_24h.exists() else {}

        hourly_data = []
        for i in range(24):
            hourly_data.append({
                "hour": intervals[i].strftime("%H:%M"),

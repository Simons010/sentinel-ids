...
class DashboardStatsView(APIView): 
    ...
    def get(self, request):
        ...
        # ⚡ Bolt: Combined 4 sequential .count() queries into a single database .aggregate()
        # to significantly reduce database network roundtrips.
        ml_stats = logs_24h.aggregate(

...
class DashboardStatsView(APIView): 
    ...
    def get(self, request):
        ...
        # Prepare aggregation buckets for logs
        log_aggs = {}
        for i in range(24):
        ...
        # Prepare aggregation buckets for alerts
        alert_aggs = {}
        for i in range(24):
            hour_start = now - timedelta(hours=24 - i)
            hour_end = hour_start + timedelta(hours=1)
...
class AnalyticsView(APIView):
    def get(self, request):
        ...
        # Use logs from last 24h as base queryset for efficiency
        ...
        log_results = logs_24h_qs.aggregate(**log_aggs)
        ...
        alert_results = alerts_24h_qs.aggregate(**alert_aggs)
